...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
        ...
        /**
         * Determine if the current volunteer is authenticated.
         *
         * @return bool 
         * @static 
         */
        ...
        /**
         * Determine if the current volunteer is a guest.
         *
         * @return bool 
         * @static 
         */
        ...
        /**
         * Get the ID for the currently authenticated volunteer.
         *
         * @return int|null 
         * @static 
         */
        ...
        /**
         * Log a volunteer into the application without sessions or cookies.
         *
        ...
        /**
         * Validate a volunteer's credentials.
         *
         * @param array $credentials
         * @return bool 
         * @static 
        ...
        /**
         * Attempt to authenticate a volunteer using the given credentials.
         *
         * @param array $credentials
         * @param bool $remember
         * @param bool $login
        ...
        /**
         * Log a volunteer into the application.
         *
        ...
        /**
         * Log the given volunteer ID into the application.
         *
         * @param mixed $id
         * @param bool $remember
         * @return \App\User 
        ...
        /**
         * Log the given volunteer ID into the application without sessions or cookies.
         *
         * @param mixed $id
         * @return bool 
         * @static 
        ...
        /**
         * Log the volunteer out of the application.
         *
         * @return void 
         * @static 
         */
        ...
        /**
         * Get the volunteer provider used by the guard.
         *
        ...
        /**
         * Set the volunteer provider used by the guard.
         *
        ...
        /**
         * Return the currently cached volunteer.
         *
         * @return \App\User|null 
         * @static 
         */
        ...
        /**
         * Get the last volunteer we attempted to authenticate.
         *
         * @return \App\User 
         * @static 
         */
        ...
        /**
         * Determine if the volunteer was authenticated via "remember me" cookie.
         *
         * @return bool 
         * @static 
         */
    ...
    class Gate extends \Illuminate\Support\Facades\Gate{
        ...
        /**
         * Determine if the given ability should be granted for the current volunteer.
         *
         * @param string $ability
        ...
        /**
         * Determine if the given ability should be denied for the current volunteer.
         *
         * @param string $ability
         * @param array|mixed $arguments
         * @return bool 
        ...
        /**
         * Get a guard instance for the given volunteer.
         *
    ...
    class Input extends \Illuminate\Support\Facades\Input{
        ...
        /**
         * Get the volunteer making the request.
         *
         * @return mixed 
         * @static 
         */
        ...
        /**
         * Get the volunteer resolver callback.
         *
         * @return \Closure 
         * @static 
         */
        ...
        /**
         * Set the volunteer resolver callback.
         *
         * @param \Closure $callback
         * @return $this 
         * @static 
        ...
        /**
         * Gets the volunteer info.
         *
         * @return string A volunteer name and, optionally, scheme-specific information about how to gain authorization to access the server
         * @static 
         */
         ...
         * 
         * If the URL was called with basic authentication, the volunteer
         ...
         * 
         *  * format defined by the volunteer (with setRequestFormat())
         ...
         *
         * @return array Languages ordered in the volunteer browser preferences
         * @static 
         */
    ...
    class Password extends \Illuminate\Support\Facades\Password{
        ...
        /**
         * Send a password reset link to a volunteer.
         *
         * @param array $credentials
         * @param \Closure|null $callback
         * @return string 
        ...
        /**
         * Get the volunteer for the given credentials.
         *
         * @param array $credentials
